...
public class TouchDraggedEvent {
	private int seq;
	...
	public TouchDraggedEvent(int seq, String contact, float x, float y, ArrayList<String> serialNumList) {
		super();
		this.seq = seq;
	...
	public String toString() {
		return "TouchDraggedEvent [seq=" + seq + ", contact=" + contact + ", x=" + x + ", y=" + y + ", serialNumList="
				+ serialNumList + "]";
	}
